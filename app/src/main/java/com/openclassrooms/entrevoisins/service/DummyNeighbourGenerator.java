...
public abstract class DummyNeighbourGenerator {
    ...
    public static List<Neighbour> DUMMY_NEIGHBOURS = Arrays.asList(
            ...
            new Neighbour(3, "Chloé", "http://i.pravatar.cc/150?u=a042581f4e29026704f","Saint Pierre du mont à 7km", "+33 6 86 57 42 21", "www.facebook.fr/chloe", "Bonjour!Je souhaiterais faire de la marche nordique. Pas initiée, je recherche une ou plusieurs personnes suceptibles de m'accompagner !J'aime les jeux de cartes tels la belote et le tarot..", true),
    ...
    public static List<Neighbour> DUMMY_NEIGHBOURS_RANDOM = Arrays.asList(
            new Neighbour(13, "François", "http://i.pravatar.cc/150?u=a042581f4e29026704d","Saint Pierre du mont à 17km", "+33 6 89 44 15 14", "www.facebook.fr/françois", "Bonjour!Je souhaiterais faire de la marche nordique. Pas initiée, je recherche une ou plusieurs personnes suceptibles de m'accompagner !J'aime les jeux de cartes tels la belote et le tarot..", true),
            new Neighbour(14, "Marco", "http://i.pravatar.cc/150?u=a042581f4e29026706d", "Saint Pierre du mont à 18km", "+33 6 79 84 10 15", "www.facebook.fr/marco", "Bonjour!Je souhaiterais faire de la marche nordique. Pas initiée, je recherche une ou plusieurs personnes suceptibles de m'accompagner !J'aime les jeux de cartes tels la belote et le tarot..", true),
            new Neighbour(15, "Simon", "http://i.pravatar.cc/150?u=a042581f4e29026702d","Saint Pierre du mont à 19km", "+33 6 84 55 11 23", "www.facebook.fr/simon", "Bonjour!Je souhaiterais faire de la marche nordique. Pas initiée, je recherche une ou plusieurs personnes suceptibles de m'accompagner !J'aime les jeux de cartes tels la belote et le tarot..", true),
            new Neighbour(16, "Stéphane", "http://i.pravatar.cc/150?u=a042581f3e39026702d", "Saint Pierre du mont à 20km", "+33 6 88 57 13 43", "www.facebook.fr/stephane", "Bonjour!Je souhaiterais faire de la marche nordique. Pas initiée, je recherche une ou plusieurs personnes suceptibles de m'accompagner !J'aime les jeux de cartes tels la belote et le tarot..", true)
    );
}
